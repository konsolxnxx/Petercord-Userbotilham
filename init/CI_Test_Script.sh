...
tg_sendinfo "<code>I am gonna merge staging into Petercord User</code>"
cd
...
git push --force origin staging: pocong
tg_sendinfo "<code>I have merged all commits from staging into Pocong Userbot</code>"
